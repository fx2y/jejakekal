...
export async function resetAppTables(client) {
  ...
  await client.query(
    'TRUNCATE side_effects, workflow_input_claims, artifact, chat_event, ocr_page, ocr_patch, ocr_job, docir_page_version, block, doc_ver, doc RESTART IDENTITY CASCADE'
  );
}
